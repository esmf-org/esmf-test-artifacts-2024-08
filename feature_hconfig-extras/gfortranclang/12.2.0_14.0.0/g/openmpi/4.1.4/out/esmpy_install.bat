...
cd /Users/sacks/projects/scratch/esmf-testing/gfortranclang_12.2.0_14.0.0_openmpi_g_feature_hconfig-extras/esmf
...
python3 -m pip install . 2>&1| tee /Users/sacks/projects/scratch/esmf-testing/gfortranclang_12.2.0_14.0.0_openmpi_g_feature_hconfig-extras/esmpy-install.log
make download 2>&1| tee /Users/sacks/projects/scratch/esmf-testing/gfortranclang_12.2.0_14.0.0_openmpi_g_feature_hconfig-extras/esmpy-download.log
deactivate
conda deactivate
