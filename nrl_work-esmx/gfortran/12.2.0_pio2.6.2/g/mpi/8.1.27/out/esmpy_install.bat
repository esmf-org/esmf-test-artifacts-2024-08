...
cd /glade/derecho/scratch/sacks/esmf-testing/gfortran_12.2.0_pio2.6.2_mpi_g_nrl_work-esmx/esmf
...
python3 -m pip install . 2>&1| tee /glade/derecho/scratch/sacks/esmf-testing/gfortran_12.2.0_pio2.6.2_mpi_g_nrl_work-esmx/esmpy-install.log
make download 2>&1| tee /glade/derecho/scratch/sacks/esmf-testing/gfortran_12.2.0_pio2.6.2_mpi_g_nrl_work-esmx/esmpy-download.log
deactivate
conda deactivate
