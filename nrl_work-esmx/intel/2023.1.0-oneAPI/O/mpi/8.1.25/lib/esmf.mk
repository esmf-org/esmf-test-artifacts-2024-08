...
ESMF_APPSDIR=/tmp/intel_2023.1.0-oneAPI_mpi_O_nrl_work-esmx/esmf/apps/appsO/Unicos.intel.64.mpi.default
ESMF_LIBSDIR=/tmp/intel_2023.1.0-oneAPI_mpi_O_nrl_work-esmx/esmf/lib/libO/Unicos.intel.64.mpi.default
ESMF_ESMXDIR=/tmp/intel_2023.1.0-oneAPI_mpi_O_nrl_work-esmx/esmf/src/addon/ESMX
...
ESMF_F90COMPILEPATHS=-I/tmp/intel_2023.1.0-oneAPI_mpi_O_nrl_work-esmx/esmf/mod/modO/Unicos.intel.64.mpi.default -I/tmp/intel_2023.1.0-oneAPI_mpi_O_nrl_work-esmx/esmf/src/include -I/opt/cray/pe/netcdf/4.9.0.3/intel/19.0/include -I/opt/cray/pe/netcdf/4.9.0.3/intel/19.0/include
ESMF_F90COMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMF_VERSION_STRING_GIT='v8.7.0b10-21-g6127c6256e' -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_PIO=1 -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_O -DESMF_TESTPERFORMANCE -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DS64=1 -DESMF_OS_Unicos=1 -DESMF_COMM=mpi -DESMF_DIR=/tmp/intel_2023.1.0-oneAPI_mpi_O_nrl_work-esmx/esmf
...
ESMF_F90LINKPATHS=-L/tmp/intel_2023.1.0-oneAPI_mpi_O_nrl_work-esmx/esmf/lib/libO/Unicos.intel.64.mpi.default -L/opt/cray/pe/netcdf/4.9.0.3/intel/19.0/lib 
ESMF_F90ESMFLINKPATHS=-L/tmp/intel_2023.1.0-oneAPI_mpi_O_nrl_work-esmx/esmf/lib/libO/Unicos.intel.64.mpi.default
ESMF_F90LINKRPATHS=-Wl,-rpath,/tmp/intel_2023.1.0-oneAPI_mpi_O_nrl_work-esmx/esmf/lib/libO/Unicos.intel.64.mpi.default -Wl,-rpath,/opt/cray/pe/netcdf/4.9.0.3/intel/19.0/lib 
ESMF_F90ESMFLINKRPATHS=-Wl,-rpath,/tmp/intel_2023.1.0-oneAPI_mpi_O_nrl_work-esmx/esmf/lib/libO/Unicos.intel.64.mpi.default
...
ESMF_CXXCOMPILEPATHS= -I/tmp/intel_2023.1.0-oneAPI_mpi_O_nrl_work-esmx/esmf/src/include  -I/opt/cray/pe/netcdf/4.9.0.3/intel/19.0/include -I/tmp/intel_2023.1.0-oneAPI_mpi_O_nrl_work-esmx/esmf/src/prologue/yaml-cpp/include
...
ESMF_CXXLINKPATHS=-L/tmp/intel_2023.1.0-oneAPI_mpi_O_nrl_work-esmx/esmf/lib/libO/Unicos.intel.64.mpi.default -L/opt/cray/pe/netcdf/4.9.0.3/intel/19.0/lib -L/opt/intel/oneapi/compiler/2023.1.0/linux/compiler/lib/intel64_lin/
ESMF_CXXESMFLINKPATHS=-L/tmp/intel_2023.1.0-oneAPI_mpi_O_nrl_work-esmx/esmf/lib/libO/Unicos.intel.64.mpi.default
ESMF_CXXLINKRPATHS=-Wl,-rpath,/tmp/intel_2023.1.0-oneAPI_mpi_O_nrl_work-esmx/esmf/lib/libO/Unicos.intel.64.mpi.default -Wl,-rpath,/opt/cray/pe/netcdf/4.9.0.3/intel/19.0/lib 
ESMF_CXXESMFLINKRPATHS=-Wl,-rpath,/tmp/intel_2023.1.0-oneAPI_mpi_O_nrl_work-esmx/esmf/lib/libO/Unicos.intel.64.mpi.default
...
ESMF_CCOMPILEPATHS=-I/tmp/intel_2023.1.0-oneAPI_mpi_O_nrl_work-esmx/esmf/src/include   -I/tmp/intel_2023.1.0-oneAPI_mpi_O_nrl_work-esmx/esmf/build_config/Unicos.intel.default
...
ESMF_CLINKPATHS=-L/tmp/intel_2023.1.0-oneAPI_mpi_O_nrl_work-esmx/esmf/lib/libO/Unicos.intel.64.mpi.default -L/opt/cray/pe/netcdf/4.9.0.3/intel/19.0/lib -L/opt/intel/oneapi/compiler/2023.1.0/linux/compiler/lib/intel64_lin/ -L/tmp/intel_2023.1.0-oneAPI_mpi_O_nrl_work-esmx/esmf/lib/libO/Unicos.intel.64.mpi.default -L/opt/cray/pe/netcdf/4.9.0.3/intel/19.0/lib 
ESMF_CESMFLINKPATHS=-L/tmp/intel_2023.1.0-oneAPI_mpi_O_nrl_work-esmx/esmf/lib/libO/Unicos.intel.64.mpi.default
ESMF_CLINKRPATHS=-Wl,-rpath,/tmp/intel_2023.1.0-oneAPI_mpi_O_nrl_work-esmx/esmf/lib/libO/Unicos.intel.64.mpi.default -Wl,-rpath,/opt/cray/pe/netcdf/4.9.0.3/intel/19.0/lib -Wl,-rpath,/opt/intel/oneapi/compiler/2023.1.0/linux/compiler/lib/intel64_lin/ -Wl,-rpath,/tmp/intel_2023.1.0-oneAPI_mpi_O_nrl_work-esmx/esmf/lib/libO/Unicos.intel.64.mpi.default -Wl,-rpath,/opt/cray/pe/netcdf/4.9.0.3/intel/19.0/lib
ESMF_CESMFLINKRPATHS=-Wl,-rpath,/tmp/intel_2023.1.0-oneAPI_mpi_O_nrl_work-esmx/esmf/lib/libO/Unicos.intel.64.mpi.default
...
ESMF_TRACE_LDPRELOAD=/tmp/intel_2023.1.0-oneAPI_mpi_O_nrl_work-esmx/esmf/lib/libO/Unicos.intel.64.mpi.default/libesmftrace_preload.so
...
ESMF_INTERNAL_DIR=/tmp/intel_2023.1.0-oneAPI_mpi_O_nrl_work-esmx/esmf
ESMF_INTERNAL_MPIRUN="/tmp/intel_2023.1.0-oneAPI_mpi_O_nrl_work-esmx/esmf/scripts/mpirun.srun "

#
# !!! The following options were used on this ESMF build !!!
#
# ESMF_DIR: /tmp/intel_2023.1.0-oneAPI_mpi_O_nrl_work-esmx/esmf
# ESMF_OS: Unicos
# ESMF_MACHINE: x86_64
# ESMF_ABI: 64
# ESMF_COMPILER: intel
